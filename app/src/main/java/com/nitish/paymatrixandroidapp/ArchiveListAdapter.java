...
public class ArchiveListAdapter extends RecyclerView.Adapter<ArchiveListAdapter.ProgrammingViewHolder> {


    private ArrayList<HashMap> map;

    public ArchiveListAdapter(ArrayList<HashMap> map){
        this.map = map;
    }
    ...
    public ProgrammingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.archive_list_item,parent,false);
